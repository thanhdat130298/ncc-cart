...
<template>
  <div>
    <div class="container">
      ...
      <div v-for="products in product" style="float: left;" :key="products.idPro">
        <p style="width: 20%;">{{ products.name }}</p>
        <p style="width: 20%;">{{ products.price }}</p>
        <p style="width: 20%; clear: left;">{{ products.idPro }}</p></div>
