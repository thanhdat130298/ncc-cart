...
export default {
  ...
  methods: {
    ...
    updateCart(products) {
      ...
      var found = this.cart.find(element => element == products[this.idBut]);
      var finded = this.product.find(element => element == this.cart[this.idBut]);
      if (found == finded) {
        return console.log(found);
      } else return console.log("asd");
    }
  },
  computed: {
    returnCart() {
