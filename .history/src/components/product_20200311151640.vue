<template>
  <div>
    <div class="container">
      ...
      <div v-for="carts in cart" v-bind:key="carts.id" class="cartdetail">
  ...
  methods: {
    ...
    updateCart(products) {
      ...
      if (found) {
        ...
        this.cart.push({
          quantity: 1,
          idPro: this.product[this.idPro].idPro,
          price: this.product[this.idPro].price,
          name: this.product[this.idPro].name,
        });
      }
