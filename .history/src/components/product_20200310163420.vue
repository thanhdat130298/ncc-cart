...
<template>
  <div>
    <div class="container">
      ...
      <!-- <div class="cartDetail" v-for="products in product" :key="products.name">
        {{ a }}
      </div> -->
...
export default {
  ...
  methods: {
    ...
    updateCart(products) {
      ...
      if (found) {
        products.quantity++;
        console.log("trung"), console.log(products.name);
      } else {
        this.cart.push(products), console.log(products.name);
      }
    }
  }
};
