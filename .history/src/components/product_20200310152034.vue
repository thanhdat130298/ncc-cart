...
export default {
  ...
  methods: {
    ...
    updateCart(products) {
      ...
      var found = this.cart.find(element => element == products);
      var find = this.products.find(element => element == this.cart);
      if(found==find) {return console.log(found);} else return console.log("asd");
    }
  },
  computed: {
    returnCart() {
