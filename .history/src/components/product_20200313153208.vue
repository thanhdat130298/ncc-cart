<template>
  <div>
    <div class="container">
      ...
      <div v-for="datas in data" v-bind:key="datas">
            <button v-on:click="test">button</button></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    test() {
      this.axios.get('https://5e6aec600f70dd001643c0b4.mockapi.io/apiv1/product/1')
      .then((response) => {
