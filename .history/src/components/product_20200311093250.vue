  ...
  <div>
    <div class="container">
      ...
      <div v-for="carts in cart" v-bind:key="carts.name" class="cartdetail">
        ...
        <div class="total">TOTAL: {{carts.price*carts.quantity}}</div>
      </div>
      <div class="clear"></div>
...
export default {
  ...
  methods: {
    ...
    updateCart(products) {
      ...
      this.nameInCart = products.name;
      
      console.log(products.quantity);
      //console.log(this.cart[this.idBut].name);
      console.log(products.price);
      //console.log(this.products[this.idPro].quantity);
      if (found) {
        products.quantity++;
      } else {
    ...
    tong(carts) {
      console.log(carts.quantity*carts.price);
    }
  }
};
</script>
