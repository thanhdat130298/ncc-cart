<template>
  <div>
    <div class="fixed">
      <div class="cart">Cart = {{ Counter }} <button class="x" v-on:click="display">X</button></div>
      <div v-for="cart in inCart" v-bind:key="cart.idPro" class="cartdetail" v-html="displa">
