...
<template>
  <div>
    <div class="container">
      ...
      <div class="pro1" v-for="products in product" :key="products.idPro">
...
export default {
  ...
  methods: {
    ...
    getId(products) {
      ...
      this.cart.push(this.idBut);
      var idd= 0, iddd= 0, idddd= 0;
      console.log(this.cart);
      if (this.products[this.idBut] == 0) idd += 1;
      else if (this.products[this.idBut]) iddd += 1;
      else idddd += 1;
    }
  },
  computed: {
    abc() {
      return this.cart.length(this.idBut);
    }
  }
};
</script>
