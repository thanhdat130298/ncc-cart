...
export default new Vuex.Store({
  ...
  actions: {
    listProduct({ commit }) {
      Vue.axios
        .get("https://192.168.0.155/product")
        .then(result => {
    ...
    saveCart(state, product) {
      ...
      if (found) {
        ...
        Vue.axios.delete(
          "https://192.168.0.155/cart/" + found.qty,
          {}
        );

        Vue.axios
          .post("https://192.168.0.155/cart", {
            idPro: product.idPro,
            price: product.price,
            name: product.name,
            qty: found.qty
        ...
        Vue.axios
          .post("https://192.168.0.155/cart/create", {
            idPro: product.idPro,
            price: product.price,
            name: product.name,
            qty: 1
