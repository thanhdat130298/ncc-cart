...
export default new Vuex.Store({
  ...
  actions: {
    ...
    listProduct({ commit }) {
      Vue.axios
        .get("https://192.168.0.155:3000/product/get")
        .then(result => {
    ...
    listCart({ commit }) {
      Vue.axios
        .get("https://192.168.0.155:3000/cart")
        .then(result => {
    ...
    saveCart(state, product) {
      ...
      if (found) {
        ...
        Vue.axios
          .put("https://192.168.0.155:3000/cart/"+found.idPro, {
            idPro: product.idPro,
            price: product.price,
            name: product.name,
            qty: found.qty
        ...
        Vue.axios
          .post("https://192.168.0.155:3000/cart/create", {
            idPro: product.idPro,
            price: product.price,
            name: product.name,
            qty: 1
